...
sims_shark = ['SharkSU', 'SharkUNIT1Gpc'] 

def get_shark_config(sim, snap, subvols, laptop=False, verbose=False):
    """
    ...
    sim : str
        ...
        after an underscore, e.g. 'SharkUNIT1Gpc_fnl0'.
    snap : integer
        Snapshot number
    ...
    if simtype not in sims_shark:
        raise ValueError(f"Simulation type '{simtype}' not supported. Available types: {sims_shark}")
